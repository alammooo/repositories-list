...
export default function RepoCards({ datas }: { datas: any }) {
        ...
        <main
          ...
          <div>
            <div className="flex gap-1 mt-3 items-center flex-wrap">
              ...
              <h1 className="text-sm capitalize text-center block text-zinc-50 rounded-md px-2 py-1 bg-blue-500">
                {data.visibility}
              </h1>
              <h1 className="text-sm capitalize text-center block text-zinc-50 rounded-md px-2 py-1 bg-emerald-500">
                {data.size} kB
              </h1>
            </div>
            <a
            ...
            <h1 className="flex gap-1 items-center font-medium flex-wrap text-sm">
              ...
              {data.topics.length > 0
                ? data.topics?.map((el: string) => (
                    <span className="capitalize bg-blue-500 px-2 py-1 text-xs rounded-md text-white">
                      {el}
                    </span>
                  ))
                : " No topics"}
